<div>
        ...
        <div class="bg-white p-6 rounded shadow">
            <h2 class="text-xl font-bold mb-4">{{ __('Edit Videos') }}</h2>
            ...
            <form wire:submit.prevent="update">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" wire:model="url" class="w-full border-gray-300 rounded px-3 py-2" />
                    @if ($video->url)
                        <img src="{{ asset('storage/' . $video->url) }}" alt="Video" class="h-16 mt-2 rounded shadow">
                    @endif
