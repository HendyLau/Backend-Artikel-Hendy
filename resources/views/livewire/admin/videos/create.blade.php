<div>
    ...
    <div class="max-w-3xl mx-auto bg-white p-6 shadow rounded">
        <h2 class="text-xl font-bold mb-4">{{ __('Create Videos') }}</h2>
        ...
        <form wire:submit.prevent="save" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                <label class="block mb-1">{{ __('Video') }}</label>
                <input type="file" wire:model="videoFile" class="w-full" />
            ...
            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700" wire:loading.attr="disabled" wire:target="videoFile,save">
                {{ __('Save') }}
            </button>
